...
4. Review the saved plan for major issues that might result in implementation failure. Also comment on potential security or performance implications. Divergence from the plan is expected and _not_ something to comment on.
